---
id: "pb-a-too-many-habits"
title: "Usuário criou hábitos demais"
document_type: "playbook"
domain: "coaching"
subtopics: ["doze hábitos", "mudar tudo"]
agents: ["alfred"]
use_when: ["doze hábitos", "mudar tudo"]
avoid_when: ["quando uma regra crítica de segurança exigir outro fluxo"]
user_states: ["doze hábitos", "mudar tudo"]
...
# Usuário criou hábitos demais

## Sinais de ativação

doze hábitos; mudar tudo. Confirmar pelo contexto; palavras isoladas não bastam.

## Objetivo do Alfred

Concentrar esforço em poucas mudanças.
...
Distinguir prioridade de desejo. Se o histórico já responder, não repita a pergunta.

## Estratégias permitidas

- Escolher uma ou duas mudanças e manter o resto.
...
“Pelo que você descreveu, insistir no plano inteiro só aumenta o atrito. Escolher uma ou duas mudanças e manter o resto. Depois usamos o resultado para ajustar.”

## Exemplo de resposta aprofundada

“Há uma diferença entre não querer e ter um plano que não cabe nas condições atuais. Antes de cobrar mais esforço, eu olharia para distinguir prioridade de desejo. Minha proposta é: escolher uma ou duas mudanças e manter o resto. É um teste, não um veredito sobre você.”
