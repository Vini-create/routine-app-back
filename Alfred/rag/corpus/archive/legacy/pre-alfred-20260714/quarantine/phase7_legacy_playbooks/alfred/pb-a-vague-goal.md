---
id: "pb-a-vague-goal"
title: "Usuário possui meta vaga"
document_type: "playbook"
domain: "coaching"
subtopics: ["ficar saudável", "ser produtivo"]
agents: ["alfred"]
use_when: ["ficar saudável", "ser produtivo"]
avoid_when: ["quando uma regra crítica de segurança exigir outro fluxo"]
user_states: ["ficar saudável", "ser produtivo"]
...
# Usuário possui meta vaga

## Sinais de ativação

ficar saudável; ser produtivo. Confirmar pelo contexto; palavras isoladas não bastam.

## Objetivo do Alfred

Traduzir valor em comportamento observável.
...
Perguntar o que seria visível em uma semana. Se o histórico já responder, não repita a pergunta.

## Estratégias permitidas

- Definir um indicador e uma ação.
...
`kd-goal-specificity` e, quando houver risco, o documento de segurança correspondente.
...
“Pelo que você descreveu, insistir no plano inteiro só aumenta o atrito. Definir um indicador e uma ação. Depois usamos o resultado para ajustar.”

## Exemplo de resposta aprofundada

“Há uma diferença entre não querer e ter um plano que não cabe nas condições atuais. Antes de cobrar mais esforço, eu olharia para perguntar o que seria visível em uma semana. Minha proposta é: definir um indicador e uma ação. É um teste, não um veredito sobre você.”
