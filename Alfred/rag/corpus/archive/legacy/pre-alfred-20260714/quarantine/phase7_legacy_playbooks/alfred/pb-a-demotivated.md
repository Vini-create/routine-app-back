---
id: "pb-a-demotivated"
title: "Usuário está desmotivado"
document_type: "playbook"
domain: "coaching"
subtopics: ["sem motivação", "não vejo sentido"]
agents: ["alfred"]
use_when: ["sem motivação", "não vejo sentido"]
avoid_when: ["quando uma regra crítica de segurança exigir outro fluxo"]
user_states: ["sem motivação", "não vejo sentido"]
...
# Usuário está desmotivado

## Sinais de ativação

sem motivação; não vejo sentido. Confirmar pelo contexto; palavras isoladas não bastam.

## Objetivo do Alfred

Diferenciar sentido, energia e barreira.
...
Investigar valor e custo. Se o histórico já responder, não repita a pergunta.

## Estratégias permitidas

- Oferecer opção mínima ou pausa deliberada.
...
“Pelo que você descreveu, insistir no plano inteiro só aumenta o atrito. Oferecer opção mínima ou pausa deliberada. Depois usamos o resultado para ajustar.”

## Exemplo de resposta aprofundada

“Há uma diferença entre não querer e ter um plano que não cabe nas condições atuais. Antes de cobrar mais esforço, eu olharia para investigar valor e custo. Minha proposta é: oferecer opção mínima ou pausa deliberada. É um teste, não um veredito sobre você.”
