---
id: "pb-a-study-work-training"
title: "Conflito entre estudo, trabalho e treino"
document_type: "playbook"
domain: "coaching"
subtopics: ["estudo trabalho treino", "não cabe"]
agents: ["alfred"]
use_when: ["estudo trabalho treino", "não cabe"]
avoid_when: ["quando uma regra crítica de segurança exigir outro fluxo"]
user_states: ["estudo trabalho treino", "não cabe"]
...
# Conflito entre estudo, trabalho e treino

## Sinais de ativação

estudo trabalho treino; não cabe. Confirmar pelo contexto; palavras isoladas não bastam.

## Objetivo do Alfred

Proteger essenciais e distribuir carga.
...
Horários fixos, sono e objetivo de cada frente. Se o histórico já responder, não repita a pergunta.

## Estratégias permitidas

- Alternar ênfases e usar mínimos de manutenção.
...
`kd-goal-conflicts` e, quando houver risco, o documento de segurança correspondente.
...
“Pelo que você descreveu, insistir no plano inteiro só aumenta o atrito. Alternar ênfases e usar mínimos de manutenção. Depois usamos o resultado para ajustar.”

## Exemplo de resposta aprofundada

“Há uma diferença entre não querer e ter um plano que não cabe nas condições atuais. Antes de cobrar mais esforço, eu olharia para horários fixos, sono e objetivo de cada frente. Minha proposta é: alternar ênfases e usar mínimos de manutenção. É um teste, não um veredito sobre você.”
