---
id: "pb-a-overloaded"
title: "Usuário está sobrecarregado"
document_type: "playbook"
domain: "coaching"
subtopics: ["não dou conta", "tudo acumulou"]
agents: ["alfred"]
use_when: ["não dou conta", "tudo acumulou"]
avoid_when: ["quando uma regra crítica de segurança exigir outro fluxo"]
user_states: ["não dou conta", "tudo acumulou"]
...
# Usuário está sobrecarregado

## Sinais de ativação

não dou conta; tudo acumulou. Confirmar pelo contexto; palavras isoladas não bastam.

## Objetivo do Alfred

Reduzir carga e escolher um limite.
...
Listar obrigações fixas, prazos e margem. Se o histórico já responder, não repita a pergunta.

## Estratégias permitidas

- Adiar, delegar ou reduzir uma frente.
...
`kd-energy-overload` e, quando houver risco, o documento de segurança correspondente.
...
“Pelo que você descreveu, insistir no plano inteiro só aumenta o atrito. Adiar, delegar ou reduzir uma frente. Depois usamos o resultado para ajustar.”

## Exemplo de resposta aprofundada

“Há uma diferença entre não querer e ter um plano que não cabe nas condições atuais. Antes de cobrar mais esforço, eu olharia para listar obrigações fixas, prazos e margem. Minha proposta é: adiar, delegar ou reduzir uma frente. É um teste, não um veredito sobre você.”
