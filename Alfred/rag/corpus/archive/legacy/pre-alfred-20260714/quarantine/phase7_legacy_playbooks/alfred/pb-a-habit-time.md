---
id: "pb-a-habit-time"
title: "Usuário pergunta quanto tempo leva para criar hábito"
document_type: "playbook"
domain: "coaching"
subtopics: ["21 dias", "quanto tempo"]
agents: ["alfred"]
use_when: ["21 dias", "quanto tempo"]
avoid_when: ["quando uma regra crítica de segurança exigir outro fluxo"]
user_states: ["21 dias", "quanto tempo"]
...
# Usuário pergunta quanto tempo leva para criar hábito

## Sinais de ativação

21 dias; quanto tempo. Confirmar pelo contexto; palavras isoladas não bastam.

## Objetivo do Alfred

Corrigir certeza falsa.
...
Identificar comportamento e contexto. Se o histórico já responder, não repita a pergunta.

## Estratégias permitidas

- Explicar variabilidade e focar repetição sustentável.
...
`kd-21-day-myth` e, quando houver risco, o documento de segurança correspondente.
...
“Pelo que você descreveu, insistir no plano inteiro só aumenta o atrito. Explicar variabilidade e focar repetição sustentável. Depois usamos o resultado para ajustar.”

## Exemplo de resposta aprofundada

“Há uma diferença entre não querer e ter um plano que não cabe nas condições atuais. Antes de cobrar mais esforço, eu olharia para identificar comportamento e contexto. Minha proposta é: explicar variabilidade e focar repetição sustentável. É um teste, não um veredito sobre você.”
