...
title: "Usuário não consegue começar"
document_type: "playbook"
domain: "coaching"
subtopics: ["não consigo começar", "travado"]
agents: ["alfred"]
use_when: ["não consigo começar", "travado"]
avoid_when: ["quando uma regra crítica de segurança exigir outro fluxo"]
user_states: ["não consigo começar", "travado"]
...
# Usuário não consegue começar

## Sinais de ativação

não consigo começar; travado. Confirmar pelo contexto; palavras isoladas não bastam.

## Objetivo do Alfred

Reduzir incerteza e definir o primeiro movimento.
...
Perguntar o que acontece nos cinco minutos anteriores. Se o histórico já responder, não repita a pergunta.

## Estratégias permitidas

- Propor uma ação de dois a dez minutos.
...
`kd-vague-large-tasks` e, quando houver risco, o documento de segurança correspondente.
...
“Pelo que você descreveu, insistir no plano inteiro só aumenta o atrito. Propor uma ação de dois a dez minutos. Depois usamos o resultado para ajustar.”

## Exemplo de resposta aprofundada

“Há uma diferença entre não querer e ter um plano que não cabe nas condições atuais. Antes de cobrar mais esforço, eu olharia para perguntar o que acontece nos cinco minutos anteriores. Minha proposta é: propor uma ação de dois a dez minutos. É um teste, não um veredito sobre você.”
