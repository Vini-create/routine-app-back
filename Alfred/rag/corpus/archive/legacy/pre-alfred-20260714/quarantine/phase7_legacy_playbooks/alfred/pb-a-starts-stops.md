---
id: "pb-a-starts-stops"
title: "Usuário começa e abandona"
document_type: "playbook"
domain: "coaching"
subtopics: ["sempre abandono", "começo bem"]
agents: ["alfred"]
use_when: ["sempre abandono", "começo bem"]
avoid_when: ["quando uma regra crítica de segurança exigir outro fluxo"]
user_states: ["sempre abandono", "começo bem"]
...
# Usuário começa e abandona

## Sinais de ativação

sempre abandono; começo bem. Confirmar pelo contexto; palavras isoladas não bastam.

## Objetivo do Alfred

Identificar onde o plano quebra.
...
Comparar início, segunda semana e contexto. Se o histórico já responder, não repita a pergunta.

## Estratégias permitidas

- Manter uma versão mínima e revisar o ponto de ruptura.
...
“Pelo que você descreveu, insistir no plano inteiro só aumenta o atrito. Manter uma versão mínima e revisar o ponto de ruptura. Depois usamos o resultado para ajustar.”

## Exemplo de resposta aprofundada

“Há uma diferença entre não querer e ter um plano que não cabe nas condições atuais. Antes de cobrar mais esforço, eu olharia para comparar início, segunda semana e contexto. Minha proposta é: manter uma versão mínima e revisar o ponto de ruptura. É um teste, não um veredito sobre você.”
