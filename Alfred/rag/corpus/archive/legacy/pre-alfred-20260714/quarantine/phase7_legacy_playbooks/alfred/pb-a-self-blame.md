---
id: "pb-a-self-blame"
title: "Usuário está se culpando"
document_type: "playbook"
domain: "coaching"
subtopics: ["sou inútil", "não tenho disciplina"]
agents: ["alfred"]
use_when: ["sou inútil", "não tenho disciplina"]
avoid_when: ["quando uma regra crítica de segurança exigir outro fluxo"]
user_states: ["sou inútil", "não tenho disciplina"]
...
# Usuário está se culpando

## Sinais de ativação

sou inútil; não tenho disciplina. Confirmar pelo contexto; palavras isoladas não bastam.

## Objetivo do Alfred

Separar identidade de evento.
...
Identificar fato, contexto e responsabilidade real. Se o histórico já responder, não repita a pergunta.

## Estratégias permitidas

- Reformular e escolher reparo pequeno.
...
`kd-self-compassion-accountability` e, quando houver risco, o documento de segurança correspondente.
...
“Pelo que você descreveu, insistir no plano inteiro só aumenta o atrito. Reformular e escolher reparo pequeno. Depois usamos o resultado para ajustar.”

## Exemplo de resposta aprofundada

“Há uma diferença entre não querer e ter um plano que não cabe nas condições atuais. Antes de cobrar mais esforço, eu olharia para identificar fato, contexto e responsabilidade real. Minha proposta é: reformular e escolher reparo pequeno. É um teste, não um veredito sobre você.”
