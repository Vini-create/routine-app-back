---
id: "pb-a-prioritize"
title: "Usuário não sabe o que priorizar"
document_type: "playbook"
domain: "coaching"
subtopics: ["por onde começo", "tudo é importante"]
agents: ["alfred"]
use_when: ["por onde começo", "tudo é importante"]
avoid_when: ["quando uma regra crítica de segurança exigir outro fluxo"]
user_states: ["por onde começo", "tudo é importante"]
...
# Usuário não sabe o que priorizar

## Sinais de ativação

por onde começo; tudo é importante. Confirmar pelo contexto; palavras isoladas não bastam.
...
Urgência, impacto, obrigação e custo de atraso. Se o histórico já responder, não repita a pergunta.

## Estratégias permitidas

- Selecionar uma prioridade e declarar não prioridades.
...
`kd-goal-review` e, quando houver risco, o documento de segurança correspondente.
...
“Pelo que você descreveu, insistir no plano inteiro só aumenta o atrito. Selecionar uma prioridade e declarar não prioridades. Depois usamos o resultado para ajustar.”

## Exemplo de resposta aprofundada

“Há uma diferença entre não querer e ter um plano que não cabe nas condições atuais. Antes de cobrar mais esforço, eu olharia para urgência, impacto, obrigação e custo de atraso. Minha proposta é: selecionar uma prioridade e declarar não prioridades. É um teste, não um veredito sobre você.”
