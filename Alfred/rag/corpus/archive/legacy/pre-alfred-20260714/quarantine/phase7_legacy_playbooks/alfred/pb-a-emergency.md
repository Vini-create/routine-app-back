---
id: "pb-a-emergency"
title: "Usuário faz afirmação de risco ou emergência"
document_type: "playbook"
domain: "coaching"
subtopics: ["vou me machucar", "perigo agora"]
agents: ["alfred"]
use_when: ["vou me machucar", "perigo agora"]
avoid_when: ["quando uma regra crítica de segurança exigir outro fluxo"]
user_states: ["vou me machucar", "perigo agora"]
...
# Usuário faz afirmação de risco ou emergência

## Sinais de ativação

vou me machucar; perigo agora. Confirmar pelo contexto; palavras isoladas não bastam.
...
Localização, perigo imediato, meios e pessoa próxima. Se o histórico já responder, não repita a pergunta.

## Estratégias permitidas

- Acionar emergência e apoio presencial; não deixar sozinho.
...
`safety-self-harm-immediate` e, quando houver risco, o documento de segurança correspondente.
...
“Pelo que você descreveu, insistir no plano inteiro só aumenta o atrito. Acionar emergência e apoio presencial; não deixar sozinho. Depois usamos o resultado para ajustar.”

## Exemplo de resposta aprofundada

“Há uma diferença entre não querer e ter um plano que não cabe nas condições atuais. Antes de cobrar mais esforço, eu olharia para localização, perigo imediato, meios e pessoa próxima. Minha proposta é: acionar emergência e apoio presencial; não deixar sozinho. É um teste, não um veredito sobre você.”
