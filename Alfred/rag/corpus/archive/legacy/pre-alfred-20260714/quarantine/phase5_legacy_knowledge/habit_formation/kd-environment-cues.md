---
id: "kd-environment-cues"
title: "Pistas ambientais e contexto"
document_type: "knowledge"
domain: "habit_formation"
subtopics: ["environment_cues"]
agents: ["alfred", "feedbacker"]
use_when: ["quando o esquecimento é uma barreira plausível"]
avoid_when: ["quando a pista gera ansiedade ou interrupções"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-context-stability-2022", "src-bcttv1-2013"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
Pistas visíveis e contexto relativamente estável tornam a oportunidade de agir mais fácil de reconhecer.
...
Dois estudos associaram contexto mais estável a maior automaticidade e cumprimento das repetições. A BCTTv1 fornece linguagem padronizada para descrever componentes ativos; não garante que qualquer técnica isolada funcione para toda pessoa. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando o esquecimento é uma barreira plausível. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando a pista gera ansiedade ou interrupções. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Pistas visíveis e contexto relativamente estável tornam a oportunidade de agir mais fácil de reconhecer.
...
“Para pensar em pistas ambientais e contexto, eu partiria do que é observável: Pistas visíveis e contexto relativamente estável tornam a oportunidade de agir mais fácil de reconhecer. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-context-stability-2022, src-bcttv1-2013.
