---
id: "kd-autonomy-competence-relatedness"
title: "Autonomia, competência e pertencimento"
document_type: "knowledge"
domain: "motivation"
subtopics: ["autonomy_competence_relatedness"]
agents: ["alfred", "feedbacker"]
use_when: ["ao formular opções e feedback"]
avoid_when: ["quando pertencimento é usado como pressão social"]
user_states: []
...
Apoiar escolha, oferecer desafio calibrado e preservar conexão pode favorecer motivação de melhor qualidade.
...
Aplicar ao formular opções e feedback. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando pertencimento é usado como pressão social. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Apoiar escolha, oferecer desafio calibrado e preservar conexão pode favorecer motivação de melhor qualidade.
...
“Para pensar em autonomia, competência e pertencimento, eu partiria do que é observável: Apoiar escolha, oferecer desafio calibrado e preservar conexão pode favorecer motivação de melhor qualidade. Vamos ajustar uma variável de cada vez e revisar com dados.”
