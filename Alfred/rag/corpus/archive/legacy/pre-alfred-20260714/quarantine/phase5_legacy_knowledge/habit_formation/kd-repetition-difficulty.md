---
id: "kd-repetition-difficulty"
title: "Repetição, complexidade e dificuldade"
document_type: "knowledge"
domain: "habit_formation"
subtopics: ["repetition_difficulty"]
agents: ["alfred", "feedbacker"]
use_when: ["ao calibrar a versão inicial"]
avoid_when: ["quando se promete prazo universal"]
user_states: []
...
# Repetição, complexidade e dificuldade

## Resumo

Comportamentos mais complexos tendem a exigir mais preparação; frequência sozinha não elimina complexidade.
...
Aplicar ao calibrar a versão inicial. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando se promete prazo universal. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Comportamentos mais complexos tendem a exigir mais preparação; frequência sozinha não elimina complexidade.
...
“Para pensar em repetição, complexidade e dificuldade, eu partiria do que é observável: Comportamentos mais complexos tendem a exigir mais preparação; frequência sozinha não elimina complexidade. Vamos ajustar uma variável de cada vez e revisar com dados.”
