---
id: "kd-energy-overload"
title: "Energia, sobrecarga e decisões"
document_type: "knowledge"
domain: "decision_making"
subtopics: ["energy_overload"]
agents: ["alfred", "feedbacker"]
use_when: ["quando decisões repetidas aparecem junto a queda de execução"]
avoid_when: ["quando sintomas persistentes pedem avaliação de saúde"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-self-regulation-2020"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
# Energia, sobrecarga e decisões

## Resumo

Cansaço e muitas demandas podem piorar execução, mas ‘fadiga decisória’ deve ser hipótese contextual, não mecanismo universal.
...
Metarrevisão encontrou apoio contextual para metas, monitoramento e feedback, sem técnica universalmente eficaz. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando decisões repetidas aparecem junto a queda de execução. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando sintomas persistentes pedem avaliação de saúde. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Cansaço e muitas demandas podem piorar execução, mas ‘fadiga decisória’ deve ser hipótese contextual, não mecanismo universal.
...
“Para pensar em energia, sobrecarga e decisões, eu partiria do que é observável: Cansaço e muitas demandas podem piorar execução, mas ‘fadiga decisória’ deve ser hipótese contextual, não mecanismo universal. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-self-regulation-2020.
