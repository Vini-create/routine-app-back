...
title: "Comportamento observável antes da explicação"
document_type: "knowledge"
domain: "behavior_change"
subtopics: ["behavior_observable"]
agents: ["alfred", "feedbacker"]
use_when: ["quando o relato é um rótulo pessoal"]
avoid_when: ["quando há emergência ou pedido clínico"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-bcttv1-2013", "src-bcto-2024"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
# Comportamento observável antes da explicação

## Resumo

Descrever ação, contexto, frequência e duração reduz interpretações vagas como ‘sou indisciplinado’.
...
Aplicar quando o relato é um rótulo pessoal. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando há emergência ou pedido clínico. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Descrever ação, contexto, frequência e duração reduz interpretações vagas como ‘sou indisciplinado’.
...
“Para pensar em comportamento observável antes da explicação, eu partiria do que é observável: Descrever ação, contexto, frequência e duração reduz interpretações vagas como ‘sou indisciplinado’. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-bcttv1-2013, src-bcto-2024.
