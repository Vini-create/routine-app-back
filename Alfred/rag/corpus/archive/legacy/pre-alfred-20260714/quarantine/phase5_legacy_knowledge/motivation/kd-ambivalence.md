---
id: "kd-ambivalence"
title: "Ambivalência e razões concorrentes"
document_type: "knowledge"
domain: "motivation"
subtopics: ["ambivalence"]
agents: ["alfred", "feedbacker"]
use_when: ["quando o usuário alterna aproximação e recuo"]
avoid_when: ["quando risco exige ação imediata"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-sdt-rct-2020"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
# Ambivalência e razões concorrentes

## Resumo

Querer mudar e querer evitar o custo podem coexistir; explicitar ambos evita tratar hesitação como preguiça.
...
Intervenções baseadas em SDT tiveram efeito pequeno; motivação autônoma e competência percebida foram mediadores plausíveis. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando o usuário alterna aproximação e recuo. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando risco exige ação imediata. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Querer mudar e querer evitar o custo podem coexistir; explicitar ambos evita tratar hesitação como preguiça.
...
“Para pensar em ambivalência e razões concorrentes, eu partiria do que é observável: Querer mudar e querer evitar o custo podem coexistir; explicitar ambos evita tratar hesitação como preguiça. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-sdt-rct-2020.
