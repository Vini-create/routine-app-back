---
id: "kd-failure-perfectionism"
title: "Medo de fracasso e perfeccionismo"
document_type: "knowledge"
domain: "procrastination"
subtopics: ["failure_perfectionism"]
agents: ["alfred", "feedbacker"]
use_when: ["quando padrões impossíveis bloqueiam entrega"]
avoid_when: ["quando é preciso encaminhar sofrimento persistente"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-perfectionism-2024", "src-procrastination-treatment-2018"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
# Medo de fracasso e perfeccionismo

## Resumo

Preocupações perfeccionistas se associam a sofrimento, mas a relação causal individual não deve ser presumida.
...
A fonte oferece a base conceitual ou operacional indicada, com aplicação dependente do contexto. A fonte oferece a base conceitual ou operacional indicada, com aplicação dependente do contexto. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando padrões impossíveis bloqueiam entrega. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando é preciso encaminhar sofrimento persistente. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Preocupações perfeccionistas se associam a sofrimento, mas a relação causal individual não deve ser presumida.
...
“Para pensar em medo de fracasso e perfeccionismo, eu partiria do que é observável: Preocupações perfeccionistas se associam a sofrimento, mas a relação causal individual não deve ser presumida. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-perfectionism-2024, src-procrastination-treatment-2018.
