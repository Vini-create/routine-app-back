...
domain: "goals"
subtopics: ["goal_review"]
agents: ["alfred", "feedbacker"]
use_when: ["em ciclos semanais ou após mudança de contexto"]
avoid_when: ["durante crise aguda, quando segurança vem primeiro"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-bcttv1-2013", "src-goal-setting-2017"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
Revisar não é negociar com cada desconforto: é comparar prioridade, custo, progresso e condições atuais.
...
A BCTTv1 fornece linguagem padronizada para descrever componentes ativos; não garante que qualquer técnica isolada funcione para toda pessoa. Definir metas teve efeito positivo pequeno em diferentes comportamentos; moderadores e desenho da meta importam. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar em ciclos semanais ou após mudança de contexto. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar durante crise aguda, quando segurança vem primeiro. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Revisar não é negociar com cada desconforto: é comparar prioridade, custo, progresso e condições atuais.
...
“Para pensar em revisão de metas, eu partiria do que é observável: Revisar não é negociar com cada desconforto: é comparar prioridade, custo, progresso e condições atuais. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-bcttv1-2013, src-goal-setting-2017.
