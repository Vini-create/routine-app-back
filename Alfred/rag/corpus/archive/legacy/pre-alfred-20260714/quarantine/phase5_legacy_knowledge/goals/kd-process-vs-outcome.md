---
id: "kd-process-vs-outcome"
title: "Metas de processo e resultado"
document_type: "knowledge"
domain: "goals"
subtopics: ["process_vs_outcome"]
agents: ["alfred", "feedbacker"]
use_when: ["quando o resultado demora ou depende de terceiros"]
avoid_when: ["quando processo escolhido não tem relação plausível com o objetivo"]
user_states: []
...
# Metas de processo e resultado

## Resumo

Resultados medem direção; processos criam oportunidades repetidas de influência. Ambos podem coexistir.
...
Aplicar quando o resultado demora ou depende de terceiros. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando processo escolhido não tem relação plausível com o objetivo. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Resultados medem direção; processos criam oportunidades repetidas de influência. Ambos podem coexistir.
...
“Para pensar em metas de processo e resultado, eu partiria do que é observável: Resultados medem direção; processos criam oportunidades repetidas de influência. Ambos podem coexistir. Vamos ajustar uma variável de cada vez e revisar com dados.”
