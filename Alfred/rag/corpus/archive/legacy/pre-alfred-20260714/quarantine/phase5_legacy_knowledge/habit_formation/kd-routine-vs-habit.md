---
id: "kd-routine-vs-habit"
title: "Diferença entre rotina e hábito"
document_type: "knowledge"
domain: "habit_formation"
subtopics: ["routine_vs_habit"]
agents: ["alfred", "feedbacker"]
use_when: ["quando o usuário chama qualquer agenda de hábito"]
avoid_when: ["quando a distinção não muda a ação"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-habit-lally-2010"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
# Diferença entre rotina e hábito

## Resumo

Rotina é uma sequência planejada; hábito implica resposta acionada com menor deliberação. Uma rotina pode conter hábitos e decisões.
...
Automaticidade cresceu de forma assintótica e variou muito entre pessoas e comportamentos; uma omissão pontual não zerou o processo observado. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando o usuário chama qualquer agenda de hábito. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando a distinção não muda a ação. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Rotina é uma sequência planejada; hábito implica resposta acionada com menor deliberação. Uma rotina pode conter hábitos e decisões.
...
“Para pensar em diferença entre rotina e hábito, eu partiria do que é observável: Rotina é uma sequência planejada; hábito implica resposta acionada com menor deliberação. Uma rotina pode conter hábitos e decisões. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-habit-lally-2010.
