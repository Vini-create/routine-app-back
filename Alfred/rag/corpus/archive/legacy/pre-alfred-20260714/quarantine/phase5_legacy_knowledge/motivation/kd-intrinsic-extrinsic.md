---
id: "kd-intrinsic-extrinsic"
title: "Motivação intrínseca e extrínseca sem dicotomia"
document_type: "knowledge"
domain: "motivation"
subtopics: ["intrinsic_extrinsic"]
agents: ["alfred", "feedbacker"]
use_when: ["quando se investiga por que a meta importa"]
avoid_when: ["quando rótulos motivacionais substituem barreiras concretas"]
user_states: []
...
# Motivação intrínseca e extrínseca sem dicotomia

## Resumo

Motivação varia em qualidade e pode combinar interesse, valor pessoal, obrigação e recompensa.
...
Aplicar quando se investiga por que a meta importa. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando rótulos motivacionais substituem barreiras concretas. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Motivação varia em qualidade e pode combinar interesse, valor pessoal, obrigação e recompensa.
...
“Para pensar em motivação intrínseca e extrínseca sem dicotomia, eu partiria do que é observável: Motivação varia em qualidade e pode combinar interesse, valor pessoal, obrigação e recompensa. Vamos ajustar uma variável de cada vez e revisar com dados.”
