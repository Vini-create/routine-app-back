---
id: "kd-vague-large-tasks"
title: "Tarefa vaga ou grande demais"
document_type: "knowledge"
domain: "procrastination"
subtopics: ["vague_large_tasks"]
agents: ["alfred", "feedbacker"]
use_when: ["quando o usuário não sabe por onde começar"]
avoid_when: ["quando há dependência externa não resolvida"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-procrastination-steel-2007", "src-bcttv1-2013"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
# Tarefa vaga ou grande demais

## Resumo

Definir a próxima ação e limitar o primeiro bloco reduz incerteza sem prometer que todo desconforto sumirá.
...
Aversividade, atraso da recompensa, autoeficácia e impulsividade foram correlatos importantes; não autorizam diagnóstico individual. A BCTTv1 fornece linguagem padronizada para descrever componentes ativos; não garante que qualquer técnica isolada funcione para toda pessoa. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando o usuário não sabe por onde começar. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando há dependência externa não resolvida. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Definir a próxima ação e limitar o primeiro bloco reduz incerteza sem prometer que todo desconforto sumirá.
...
“Para pensar em tarefa vaga ou grande demais, eu partiria do que é observável: Definir a próxima ação e limitar o primeiro bloco reduz incerteza sem prometer que todo desconforto sumirá. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-procrastination-steel-2007, src-bcttv1-2013.
