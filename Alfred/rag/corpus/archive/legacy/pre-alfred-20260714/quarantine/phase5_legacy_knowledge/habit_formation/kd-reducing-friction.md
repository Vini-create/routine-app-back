---
id: "kd-reducing-friction"
title: "Redução de fricção"
document_type: "knowledge"
domain: "habit_formation"
subtopics: ["reducing_friction"]
agents: ["alfred", "feedbacker"]
use_when: ["quando iniciar exige passos evitáveis"]
avoid_when: ["quando simplificar elimina requisitos de segurança"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-bcttv1-2013"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
Preparar materiais, reduzir passos e remover distrações muda a probabilidade da ação sem exigir motivação constante.
...
A BCTTv1 fornece linguagem padronizada para descrever componentes ativos; não garante que qualquer técnica isolada funcione para toda pessoa. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando iniciar exige passos evitáveis. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando simplificar elimina requisitos de segurança. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Preparar materiais, reduzir passos e remover distrações muda a probabilidade da ação sem exigir motivação constante.
...
“Para pensar em redução de fricção, eu partiria do que é observável: Preparar materiais, reduzir passos e remover distrações muda a probabilidade da ação sem exigir motivação constante. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-bcttv1-2013.
