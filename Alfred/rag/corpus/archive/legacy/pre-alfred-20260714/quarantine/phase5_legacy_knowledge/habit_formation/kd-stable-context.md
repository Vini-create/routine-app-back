---
id: "kd-stable-context"
title: "Contexto estável sem rigidez"
document_type: "knowledge"
domain: "habit_formation"
subtopics: ["stable_context"]
agents: ["alfred", "feedbacker"]
use_when: ["quando horário ou local podem ser consistentes"]
avoid_when: ["quando a vida do usuário é inevitavelmente variável"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-context-stability-2022"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
# Contexto estável sem rigidez

## Resumo

Estabilidade ajuda a reconhecer a oportunidade, mas planos precisam de alternativa para dias atípicos.
...
Dois estudos associaram contexto mais estável a maior automaticidade e cumprimento das repetições. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando horário ou local podem ser consistentes. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando a vida do usuário é inevitavelmente variável. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Estabilidade ajuda a reconhecer a oportunidade, mas planos precisam de alternativa para dias atípicos.
...
“Para pensar em contexto estável sem rigidez, eu partiria do que é observável: Estabilidade ajuda a reconhecer a oportunidade, mas planos precisam de alternativa para dias atípicos. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-context-stability-2022.
