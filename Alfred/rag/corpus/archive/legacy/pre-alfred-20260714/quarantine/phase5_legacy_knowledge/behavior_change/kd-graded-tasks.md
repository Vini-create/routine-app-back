---
id: "kd-graded-tasks"
title: "Gradação de tarefas"
document_type: "knowledge"
domain: "behavior_change"
subtopics: ["graded_tasks"]
agents: ["alfred", "feedbacker"]
use_when: ["quando a tarefa é grande ou aversiva"]
avoid_when: ["quando o usuário interpreta progressão como prescrição clínica"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-bcttv1-2013", "src-self-regulation-2020"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
Reduzir dificuldade inicial preserva a direção da meta e permite aumentar demanda com evidência de tolerância.
...
A BCTTv1 fornece linguagem padronizada para descrever componentes ativos; não garante que qualquer técnica isolada funcione para toda pessoa. Metarrevisão encontrou apoio contextual para metas, monitoramento e feedback, sem técnica universalmente eficaz. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando a tarefa é grande ou aversiva. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando o usuário interpreta progressão como prescrição clínica. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Reduzir dificuldade inicial preserva a direção da meta e permite aumentar demanda com evidência de tolerância.
...
“Para pensar em gradação de tarefas, eu partiria do que é observável: Reduzir dificuldade inicial preserva a direção da meta e permite aumentar demanda com evidência de tolerância. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-bcttv1-2013, src-self-regulation-2020.
