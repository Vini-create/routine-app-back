---
id: "kd-self-compassion-accountability"
title: "Autocompaixão com responsabilidade"
document_type: "knowledge"
domain: "emotional_support"
subtopics: ["self_compassion_accountability"]
agents: ["alfred", "feedbacker"]
use_when: ["quando culpa bloqueia a próxima ação"]
avoid_when: ["quando é usada para minimizar dano a terceiros"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-self-compassion-2021"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
Responder à falha sem hostilidade pode facilitar retomada; autocompaixão não elimina consequência, compromisso ou reparo.
...
Autocompaixão se associou modestamente a comportamentos de saúde; não equivale a permissividade nem prova causalidade em todos os domínios. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando culpa bloqueia a próxima ação. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando é usada para minimizar dano a terceiros. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Responder à falha sem hostilidade pode facilitar retomada; autocompaixão não elimina consequência, compromisso ou reparo.
...
“Para pensar em autocompaixão com responsabilidade, eu partiria do que é observável: Responder à falha sem hostilidade pode facilitar retomada; autocompaixão não elimina consequência, compromisso ou reparo. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-self-compassion-2021.
