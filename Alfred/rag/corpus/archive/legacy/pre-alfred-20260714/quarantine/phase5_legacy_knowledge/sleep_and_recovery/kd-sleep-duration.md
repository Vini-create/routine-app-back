...
title: "Duração do sono por faixa etária"
document_type: "knowledge"
domain: "sleep_and_recovery"
subtopics: ["sleep_duration"]
agents: ["alfred", "feedbacker"]
use_when: ["quando o usuário pergunta por referência geral"]
avoid_when: ["quando há insônia, apneia suspeita, mania, medicação ou sonolência perigosa"]
user_states: []
...
# Duração do sono por faixa etária

## Resumo

Recomendações populacionais são referência, não diagnóstico; adultos saudáveis geralmente precisam de sete ou mais horas regulares.
...
Consenso recomenda sete ou mais horas regulares para adultos saudáveis, reconhecendo variação individual e contexto clínico. A fonte oferece a base conceitual ou operacional indicada, com aplicação dependente do contexto. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando o usuário pergunta por referência geral. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando há insônia, apneia suspeita, mania, medicação ou sonolência perigosa. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Recomendações populacionais são referência, não diagnóstico; adultos saudáveis geralmente precisam de sete ou mais horas regulares.
...
“Para pensar em duração do sono por faixa etária, eu partiria do que é observável: Recomendações populacionais são referência, não diagnóstico; adultos saudáveis geralmente precisam de sete ou mais horas regulares. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-sleep-aasm-2015, src-sleep-nsf-2015.
