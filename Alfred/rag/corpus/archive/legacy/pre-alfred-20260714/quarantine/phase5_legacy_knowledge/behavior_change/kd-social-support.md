---
id: "kd-social-support"
title: "Apoio social apropriado"
document_type: "knowledge"
domain: "behavior_change"
subtopics: ["social_support"]
agents: ["alfred", "feedbacker"]
use_when: ["quando outra pessoa pode reduzir barreiras concretas"]
avoid_when: ["quando cria controle, exposição ou dependência"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-bcttv1-2013", "src-sdt-techniques-2019"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
# Apoio social apropriado

## Resumo

Apoio pode ser emocional, prático ou de acompanhamento; precisa ser consentido e compatível com a autonomia.
...
A BCTTv1 fornece linguagem padronizada para descrever componentes ativos; não garante que qualquer técnica isolada funcione para toda pessoa. A fonte oferece a base conceitual ou operacional indicada, com aplicação dependente do contexto. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando outra pessoa pode reduzir barreiras concretas. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando cria controle, exposição ou dependência. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Apoio pode ser emocional, prático ou de acompanhamento; precisa ser consentido e compatível com a autonomia.
...
“Para pensar em apoio social apropriado, eu partiria do que é observável: Apoio pode ser emocional, prático ou de acompanhamento; precisa ser consentido e compatível com a autonomia. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-bcttv1-2013, src-sdt-techniques-2019.
