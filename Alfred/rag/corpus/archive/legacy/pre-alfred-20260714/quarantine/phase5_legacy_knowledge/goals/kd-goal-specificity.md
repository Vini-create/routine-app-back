---
id: "kd-goal-specificity"
title: "Especificidade e mensurabilidade com sentido"
document_type: "knowledge"
domain: "goals"
subtopics: ["goal_specificity"]
agents: ["alfred", "feedbacker"]
use_when: ["quando ‘melhorar’ não orienta ação"]
avoid_when: ["quando medir aumenta risco ou obsessão"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-goal-setting-2017"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
# Especificidade e mensurabilidade com sentido

## Resumo

Uma meta deve permitir reconhecer progresso sem reduzir todo valor humano a um número.
...
Definir metas teve efeito positivo pequeno em diferentes comportamentos; moderadores e desenho da meta importam. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando ‘melhorar’ não orienta ação. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando medir aumenta risco ou obsessão. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Uma meta deve permitir reconhecer progresso sem reduzir todo valor humano a um número.
...
“Para pensar em especificidade e mensurabilidade com sentido, eu partiria do que é observável: Uma meta deve permitir reconhecer progresso sem reduzir todo valor humano a um número. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-goal-setting-2017.
