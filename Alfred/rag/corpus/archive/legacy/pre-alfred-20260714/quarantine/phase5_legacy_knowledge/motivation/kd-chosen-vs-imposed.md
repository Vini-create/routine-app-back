---
id: "kd-chosen-vs-imposed"
title: "Metas escolhidas e metas impostas"
document_type: "knowledge"
domain: "motivation"
subtopics: ["chosen_vs_imposed"]
agents: ["alfred", "feedbacker"]
use_when: ["quando há resistência a uma obrigação"]
avoid_when: ["quando validar autonomia significaria ignorar dever ou segurança"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-sdt-rct-2020", "src-sdt-techniques-2019"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
# Metas escolhidas e metas impostas

## Resumo

Autonomia não exige liberdade total; envolve compreender razões, ter voz e encontrar uma forma pessoal de cumprir restrições reais.
...
Intervenções baseadas em SDT tiveram efeito pequeno; motivação autônoma e competência percebida foram mediadores plausíveis. A fonte oferece a base conceitual ou operacional indicada, com aplicação dependente do contexto. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando há resistência a uma obrigação. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando validar autonomia significaria ignorar dever ou segurança. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Autonomia não exige liberdade total; envolve compreender razões, ter voz e encontrar uma forma pessoal de cumprir restrições reais.
...
“Para pensar em metas escolhidas e metas impostas, eu partiria do que é observável: Autonomia não exige liberdade total; envolve compreender razões, ter voz e encontrar uma forma pessoal de cumprir restrições reais. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-sdt-rct-2020, src-sdt-techniques-2019.
