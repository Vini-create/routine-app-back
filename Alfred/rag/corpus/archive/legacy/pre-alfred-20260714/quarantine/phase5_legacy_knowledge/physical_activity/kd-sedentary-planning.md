---
id: "kd-sedentary-planning"
title: "Sedentarismo e planejamento semanal"
document_type: "knowledge"
domain: "physical_activity"
subtopics: ["sedentary_planning"]
agents: ["alfred", "feedbacker"]
use_when: ["quando longos blocos sentados aparecem nos dados"]
avoid_when: ["quando pausas interferem com segurança ocupacional"]
user_states: []
...
# Sedentarismo e planejamento semanal

## Resumo

Reduzir tempo sedentário e distribuir atividade pode ser mais viável que concentrar tudo em um único dia.
...
A OMS recomenda reduzir sedentarismo e acumular atividade ao longo da semana; alguma atividade é melhor que nenhuma. A fonte oferece a base conceitual ou operacional indicada, com aplicação dependente do contexto. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar quando longos blocos sentados aparecem nos dados. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando pausas interferem com segurança ocupacional. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Reduzir tempo sedentário e distribuir atividade pode ser mais viável que concentrar tudo em um único dia.
...
“Para pensar em sedentarismo e planejamento semanal, eu partiria do que é observável: Reduzir tempo sedentário e distribuir atividade pode ser mais viável que concentrar tudo em um único dia. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-who-pa-2020, src-cdc-pa-adults.
