---
id: "kd-retrieval-practice"
title: "Prática de recuperação"
document_type: "knowledge"
domain: "study_and_learning"
subtopics: ["retrieval_practice"]
agents: ["alfred", "feedbacker"]
use_when: ["para revisar conteúdo já estudado"]
avoid_when: ["quando testes de alta pressão agravam sofrimento"]
user_states: []
evidence_level: "evidence_informed"
source_ids: ["src-learning-dunlosky-2013", "src-retrieval-meta-2021"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "low"
...
Tentar recuperar da memória com feedback costuma produzir retenção melhor que apenas reler.
...
Prática de teste e estudo distribuído receberam alta utilidade; releitura e grifo têm limites quando usados isoladamente. Meta-análise em sala de aula encontrou benefício médio de testes de baixa pressão, modulado por formato, feedback e repetição. Os achados descrevem médias e mecanismos plausíveis; a resposta deve preservar incerteza e não inferir causalidade individual sem dados.

## Quando aplicar

Aplicar para revisar conteúdo já estudado. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando testes de alta pressão agravam sofrimento. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Tentar recuperar da memória com feedback costuma produzir retenção melhor que apenas reler.
...
“Para pensar em prática de recuperação, eu partiria do que é observável: Tentar recuperar da memória com feedback costuma produzir retenção melhor que apenas reler. Vamos ajustar uma variável de cada vez e revisar com dados.”
...
IDs relacionados: src-learning-dunlosky-2013, src-retrieval-meta-2021.
