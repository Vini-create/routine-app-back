---
id: "kd-weekly-reflection"
title: "Reflexão semanal baseada em dados"
document_type: "knowledge"
domain: "self_regulation"
subtopics: ["weekly_reflection"]
agents: ["alfred", "feedbacker"]
use_when: ["quando há ao menos alguns registros"]
avoid_when: ["quando vira auditoria moral extensa"]
user_states: []
...
# Reflexão semanal baseada em dados

## Resumo

Uma revisão útil separa fatos, hipóteses, aprendizados e um ajuste pequeno para o próximo período.
...
Aplicar quando há ao menos alguns registros. Procure primeiro a descrição do comportamento, o contexto e a restrição relevante.

## Quando não aplicar

Evitar quando vira auditoria moral extensa. Sinais médicos, sofrimento grave ou risco deslocam a prioridade para os documentos de segurança.
...
2. Aplicar o princípio específico: Uma revisão útil separa fatos, hipóteses, aprendizados e um ajuste pequeno para o próximo período.
...
“Para pensar em reflexão semanal baseada em dados, eu partiria do que é observável: Uma revisão útil separa fatos, hipóteses, aprendizados e um ajuste pequeno para o próximo período. Vamos ajustar uma variável de cada vez e revisar com dados.”
