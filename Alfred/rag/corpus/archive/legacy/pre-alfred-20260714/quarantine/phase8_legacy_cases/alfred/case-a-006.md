...
user_message: "Minha meta no aplicativo é ‘ficar saudável’, mas nunca sei o que marcar como avanço."
available_data: {}
detected_topics: ["goal"]
detected_state: "a confirmar pelo contexto"
relevant_playbooks: ["pb-a-vague-goal"]
relevant_knowledge: ["kd-goal-specificity"]
risk_level: "low"
...
example_response: "Entendo a restrição concreta. Minha proposta é definir um indicador e uma ação; vamos tratar isso como um teste revisável, não como um julgamento sobre você."
status: "generated"
