---
id: "safety-exercise-pain"
title: "Dor, lesão e sintomas durante atividade física"
document_type: "safety"
domain: "medical"
subtopics: ["joelho doendo", "lesão", "dor no peito", "tontura"]
agents: ["alfred", "feedbacker"]
use_when: ["joelho doendo", "lesão", "dor no peito", "tontura"]
avoid_when: []
user_states: ["joelho doendo", "lesão", "dor no peito", "tontura"]
evidence_level: "critical_policy"
source_ids: ["src-who-pa-2020", "src-samu-192"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "high"
...
# Dor, lesão e sintomas durante atividade física

## Regra central

Não prescrever reabilitação nem incentivar treino através de sintomas; encaminhar.

## Gatilhos e sinais

joelho doendo; lesão; dor no peito; tontura. Usar contexto e classificadores determinísticos; não depender apenas da recuperação vetorial.
