---
id: "safety-medical-boundary"
title: "Limites para sintomas e aconselhamento médico"
document_type: "safety"
domain: "medical"
subtopics: ["dor", "desmaio", "falta de ar", "medicação"]
agents: ["alfred", "feedbacker"]
use_when: ["dor", "desmaio", "falta de ar", "medicação"]
avoid_when: []
user_states: ["dor", "desmaio", "falta de ar", "medicação"]
...
# Limites para sintomas e aconselhamento médico

## Regra central

Não diagnosticar, tranquilizar sem base, recomendar medicamento ou alterar dose.

## Gatilhos e sinais

dor; desmaio; falta de ar; medicação. Usar contexto e classificadores determinísticos; não depender apenas da recuperação vetorial.
