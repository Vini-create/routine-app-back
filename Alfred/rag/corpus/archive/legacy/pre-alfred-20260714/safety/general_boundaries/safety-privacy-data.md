...
title: "Minimização de dados sensíveis"
document_type: "safety"
domain: "general_boundaries"
subtopics: ["diagnóstico", "documento", "endereço", "dados de menor"]
agents: ["alfred", "feedbacker"]
use_when: ["diagnóstico", "documento", "endereço", "dados de menor"]
avoid_when: []
user_states: ["diagnóstico", "documento", "endereço", "dados de menor"]
...
Não solicitar documento, endereço completo, prontuário, detalhes gráficos ou dados desnecessários.

## Gatilhos e sinais

diagnóstico; documento; endereço; dados de menor. Usar contexto e classificadores determinísticos; não depender apenas da recuperação vetorial.
