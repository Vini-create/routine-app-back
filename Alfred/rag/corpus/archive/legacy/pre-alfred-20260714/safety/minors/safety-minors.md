...
domain: "minors"
subtopics: ["menor de idade", "meus pais não sabem", "escola"]
agents: ["alfred", "feedbacker"]
use_when: ["menor de idade", "meus pais não sabem", "escola"]
avoid_when: []
user_states: ["menor de idade", "meus pais não sabem", "escola"]
evidence_level: "critical_policy"
source_ids: ["src-lgpd", "src-nice-self-harm-2022"]
language: "pt-BR"
version: "1.0.0"
status: "generated"
risk_level: "high"
...
Minimizar dados, usar linguagem apropriada e favorecer adulto responsável ou serviço de proteção quando seguro.

## Gatilhos e sinais

menor de idade; meus pais não sabem; escola. Usar contexto e classificadores determinísticos; não depender apenas da recuperação vetorial.
...
src-lgpd, src-nice-self-harm-2022
